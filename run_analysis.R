...
colnames(agg)<-a # Apply new names to the column headers

## Write data to new text file

write.table(agg, "C:/Users/bag9031/Documents/Personal/Getting And Cleaning Data/CleanData.txt", row.names = FALSE)
